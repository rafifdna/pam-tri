...
function usage() {
  echo "$(gettext 'Server Deployment Management Script')"
  echo
  echo "Usage: "
  echo "  ./pam.sh [COMMAND] [ARGS...]"
  echo "  ./pam.sh --help"
  echo
  echo "Installation Commands: "
  echo "  install           $(gettext 'Install Server')"
  echo "  upgrade           $(gettext 'Upgrade Server')"
  echo
  echo "Management Commands: "
  echo "  config            $(gettext 'Configuration  Tools')"
  echo "  start             $(gettext 'Start     Server')"
  echo "  stop              $(gettext 'Stop      Server')"
  echo "  restart           $(gettext 'Restart   Server')"
  echo "  status            $(gettext 'Check     Server')"
  echo "  down              $(gettext 'Offline   Server')"
  echo "  uninstall         $(gettext 'Uninstall Server')"
  echo
  echo "More Commands: "
